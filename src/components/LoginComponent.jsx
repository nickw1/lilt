...
export default function LoginComponent({usercode}) {
    ...
    return usercode === null ? 
        ...
        :
        <>
        <form action={loginWithState} key='formLogin' onSubmit={() => setNewUserStage(0)}>
        ...
        <div id='loginError' style={{backgroundColor: '#ffc0c0'}}>{newUserStage < 2 && loginState?.error ? loginState.error : ""}</div>
        </form>
